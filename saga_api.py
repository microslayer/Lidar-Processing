...
class CSG_Matrix(_object):
    ...
    def Add_Col(self, *args): return _saga_api.CSG_Matrix_Add_Col(self, *args)
    def Add_Row(self, *args): return _saga_api.CSG_Matrix_Add_Row(self, *args)
    def Ins_Col(self, *args): return _saga_api.CSG_Matrix_Ins_Col(self, *args)
    def Ins_Row(self, *args): return _saga_api.CSG_Matrix_Ins_Row(self, *args)
    def Set_Col(self, *args): return _saga_api.CSG_Matrix_Set_Col(self, *args)
    def Set_Row(self, *args): return _saga_api.CSG_Matrix_Set_Row(self, *args)
    def Del_Col(self, *args): return _saga_api.CSG_Matrix_Del_Col(self, *args)
    def Del_Row(self, *args): return _saga_api.CSG_Matrix_Del_Row(self, *args)
    def Get_Col(self, *args): return _saga_api.CSG_Matrix_Get_Col(self, *args)
    def Get_Row(self, *args): return _saga_api.CSG_Matrix_Get_Row(self, *args)
    def Get_NX(self): return _saga_api.CSG_Matrix_Get_NX(self)
    def Get_NCols(self): return _saga_api.CSG_Matrix_Get_NCols(self)
    def Get_NY(self): return _saga_api.CSG_Matrix_Get_NY(self)
    def Get_NRows(self): return _saga_api.CSG_Matrix_Get_NRows(self)
...
class CSG_Test_Distribution(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, CSG_Test_Distribution, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, CSG_Test_Distribution, name)
    __repr__ = _swig_repr
    __swig_getmethods__["Get_F_Tail_from_R2"] = lambda x: _saga_api.CSG_Test_Distribution_Get_F_Tail_from_R2
    if _newclass:Get_F_Tail_from_R2 = staticmethod(_saga_api.CSG_Test_Distribution_Get_F_Tail_from_R2)
    __swig_getmethods__["Get_F_Tail"] = lambda x: _saga_api.CSG_Test_Distribution_Get_F_Tail
    if _newclass:Get_F_Tail = staticmethod(_saga_api.CSG_Test_Distribution_Get_F_Tail)
    __swig_getmethods__["Get_F_Inverse"] = lambda x: _saga_api.CSG_Test_Distribution_Get_F_Inverse
    if _newclass:Get_F_Inverse = staticmethod(_saga_api.CSG_Test_Distribution_Get_F_Inverse)
    __swig_getmethods__["Get_T_Tail"] = lambda x: _saga_api.CSG_Test_Distribution_Get_T_Tail
    if _newclass:Get_T_Tail = staticmethod(_saga_api.CSG_Test_Distribution_Get_T_Tail)
    __swig_getmethods__["Get_T_Inverse"] = lambda x: _saga_api.CSG_Test_Distribution_Get_T_Inverse
    if _newclass:Get_T_Inverse = staticmethod(_saga_api.CSG_Test_Distribution_Get_T_Inverse)
    __swig_getmethods__["Get_Norm_P"] = lambda x: _saga_api.CSG_Test_Distribution_Get_Norm_P
    if _newclass:Get_Norm_P = staticmethod(_saga_api.CSG_Test_Distribution_Get_Norm_P)
    __swig_getmethods__["Get_Norm_Z"] = lambda x: _saga_api.CSG_Test_Distribution_Get_Norm_Z
    if _newclass:Get_Norm_Z = staticmethod(_saga_api.CSG_Test_Distribution_Get_Norm_Z)
    def __init__(self): 
        this = _saga_api.new_CSG_Test_Distribution()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _saga_api.delete_CSG_Test_Distribution
    __del__ = lambda self : None;
CSG_Test_Distribution_swigregister = _saga_api.CSG_Test_Distribution_swigregister
CSG_Test_Distribution_swigregister(CSG_Test_Distribution)

def CSG_Test_Distribution_Get_F_Tail_from_R2(*args):
  return _saga_api.CSG_Test_Distribution_Get_F_Tail_from_R2(*args)
CSG_Test_Distribution_Get_F_Tail_from_R2 = _saga_api.CSG_Test_Distribution_Get_F_Tail_from_R2

def CSG_Test_Distribution_Get_F_Tail(*args):
  return _saga_api.CSG_Test_Distribution_Get_F_Tail(*args)
CSG_Test_Distribution_Get_F_Tail = _saga_api.CSG_Test_Distribution_Get_F_Tail

def CSG_Test_Distribution_Get_F_Inverse(*args):
  return _saga_api.CSG_Test_Distribution_Get_F_Inverse(*args)
CSG_Test_Distribution_Get_F_Inverse = _saga_api.CSG_Test_Distribution_Get_F_Inverse

def CSG_Test_Distribution_Get_T_Tail(*args):
  return _saga_api.CSG_Test_Distribution_Get_T_Tail(*args)
CSG_Test_Distribution_Get_T_Tail = _saga_api.CSG_Test_Distribution_Get_T_Tail

def CSG_Test_Distribution_Get_T_Inverse(*args):
  return _saga_api.CSG_Test_Distribution_Get_T_Inverse(*args)
CSG_Test_Distribution_Get_T_Inverse = _saga_api.CSG_Test_Distribution_Get_T_Inverse

def CSG_Test_Distribution_Get_Norm_P(*args):
  return _saga_api.CSG_Test_Distribution_Get_Norm_P(*args)
CSG_Test_Distribution_Get_Norm_P = _saga_api.CSG_Test_Distribution_Get_Norm_P

def CSG_Test_Distribution_Get_Norm_Z(*args):
  return _saga_api.CSG_Test_Distribution_Get_Norm_Z(*args)
CSG_Test_Distribution_Get_Norm_Z = _saga_api.CSG_Test_Distribution_Get_Norm_Z
...
def SG_Get_Correlation_Matrix(*args):
  return _saga_api.SG_Get_Correlation_Matrix(*args)
SG_Get_Correlation_Matrix = _saga_api.SG_Get_Correlation_Matrix

def SG_Regression_Get_Adjusted_R2(*args):
  return _saga_api.SG_Regression_Get_Adjusted_R2(*args)
SG_Regression_Get_Adjusted_R2 = _saga_api.SG_Regression_Get_Adjusted_R2
...
class CSG_Regression_Multiple(_object):
    ...
    def Calculate_Forward(self, *args): return _saga_api.CSG_Regression_Multiple_Calculate_Forward(self, *args)
    def Calculate_Backward(self, *args): return _saga_api.CSG_Regression_Multiple_Calculate_Backward(self, *args)
    def Calculate_Stepwise(self, *args): return _saga_api.CSG_Regression_Multiple_Calculate_Stepwise(self, *args)
    def Get_Info(self): return _saga_api.CSG_Regression_Multiple_Get_Info(self)
    def Get_Regression(self): return _saga_api.CSG_Regression_Multiple_Get_Regression(self)
    def Get_Model(self): return _saga_api.CSG_Regression_Multiple_Get_Model(self)
    def Get_Steps(self): return _saga_api.CSG_Regression_Multiple_Get_Steps(self)
    def Get_R2(self): return _saga_api.CSG_Regression_Multiple_Get_R2(self)
    def Get_R2_Adj(self): return _saga_api.CSG_Regression_Multiple_Get_R2_Adj(self)
    def Get_F(self): return _saga_api.CSG_Regression_Multiple_Get_F(self)
    def Get_DegFreedom(self): return _saga_api.CSG_Regression_Multiple_Get_DegFreedom(self)
    def Get_nSamples(self): return _saga_api.CSG_Regression_Multiple_Get_nSamples(self)
    def Get_nPredictors(self): return _saga_api.CSG_Regression_Multiple_Get_nPredictors(self)
    def Get_Predictor(self, *args): return _saga_api.CSG_Regression_Multiple_Get_Predictor(self, *args)
    ...
    def Get_ID(self, *args): return _saga_api.CSG_Regression_Multiple_Get_ID(self, *args)
    def Get_RCoeff(self, *args): return _saga_api.CSG_Regression_Multiple_Get_RCoeff(self, *args)
    def Get_R2_Partial(self, *args): return _saga_api.CSG_Regression_Multiple_Get_R2_Partial(self, *args)
    def Get_R2_Partial_Adj(self, *args): return _saga_api.CSG_Regression_Multiple_Get_R2_Partial_Adj(self, *args)
    def Get_StdError(self, *args): return _saga_api.CSG_Regression_Multiple_Get_StdError(self, *args)
    def Get_T(self, *args): return _saga_api.CSG_Regression_Multiple_Get_T(self, *args)
    def Get_P(self, *args): return _saga_api.CSG_Regression_Multiple_Get_P(self, *args)
    def Get_Parameter(self, *args): return _saga_api.CSG_Regression_Multiple_Get_Parameter(self, *args)
...
SG_META_EXT_GRID = _saga_api.SG_META_EXT_GRID
SG_META_EXT_TABLE = _saga_api.SG_META_EXT_TABLE
SG_META_EXT_SHAPES = _saga_api.SG_META_EXT_SHAPES
SG_META_EXT_TIN = _saga_api.SG_META_EXT_TIN
SG_META_EXT_POINTCLOUD = _saga_api.SG_META_EXT_POINTCLOUD
SG_META_SRC = _saga_api.SG_META_SRC
SG_META_SRC_FILE = _saga_api.SG_META_SRC_FILE
SG_META_SRC_DB = _saga_api.SG_META_SRC_DB
SG_META_SRC_PROJ = _saga_api.SG_META_SRC_PROJ
SG_META_HST = _saga_api.SG_META_HST
SG_META_HST_FILE = _saga_api.SG_META_HST_FILE
...
class CSG_Table(CSG_Data_Object):
    ...
    def Set_Field_Type(self, *args): return _saga_api.CSG_Table_Set_Field_Type(self, *args)
...
class CSG_Grid_Cell_Addressor(_object):
    ...
    def Set_Annulus(self, *args): return _saga_api.CSG_Grid_Cell_Addressor_Set_Annulus(self, *args)
...
SG_OGIS_TYPE_STR_Point = _saga_api.SG_OGIS_TYPE_STR_Point
SG_OGIS_TYPE_STR_Line = _saga_api.SG_OGIS_TYPE_STR_Line
SG_OGIS_TYPE_STR_Polygon = _saga_api.SG_OGIS_TYPE_STR_Polygon
SG_OGIS_TYPE_STR_MultiPoint = _saga_api.SG_OGIS_TYPE_STR_MultiPoint
SG_OGIS_TYPE_STR_MultiLine = _saga_api.SG_OGIS_TYPE_STR_MultiLine
SG_OGIS_TYPE_STR_MultiPolygon = _saga_api.SG_OGIS_TYPE_STR_MultiPolygon
SG_OGIS_TYPE_STR_GeometryCollection = _saga_api.SG_OGIS_TYPE_STR_GeometryCollection
SG_OGIS_TYPE_STR_PolyhedralSurface = _saga_api.SG_OGIS_TYPE_STR_PolyhedralSurface
SG_OGIS_TYPE_STR_TIN = _saga_api.SG_OGIS_TYPE_STR_TIN
SG_OGIS_TYPE_STR_Triangle = _saga_api.SG_OGIS_TYPE_STR_Triangle
SG_OGIS_TYPE_STR_Point_Z = _saga_api.SG_OGIS_TYPE_STR_Point_Z
SG_OGIS_TYPE_STR_Line_Z = _saga_api.SG_OGIS_TYPE_STR_Line_Z
SG_OGIS_TYPE_STR_Polygon_Z = _saga_api.SG_OGIS_TYPE_STR_Polygon_Z
SG_OGIS_TYPE_STR_MultiPoint_Z = _saga_api.SG_OGIS_TYPE_STR_MultiPoint_Z
SG_OGIS_TYPE_STR_MultiLine_Z = _saga_api.SG_OGIS_TYPE_STR_MultiLine_Z
SG_OGIS_TYPE_STR_MultiPolygon_Z = _saga_api.SG_OGIS_TYPE_STR_MultiPolygon_Z
SG_OGIS_TYPE_STR_GeometryCollection_Z = _saga_api.SG_OGIS_TYPE_STR_GeometryCollection_Z
SG_OGIS_TYPE_STR_PolyhedralSurface_Z = _saga_api.SG_OGIS_TYPE_STR_PolyhedralSurface_Z
SG_OGIS_TYPE_STR_TIN_Z = _saga_api.SG_OGIS_TYPE_STR_TIN_Z
SG_OGIS_TYPE_STR_Triangle_Z = _saga_api.SG_OGIS_TYPE_STR_Triangle_Z
SG_OGIS_TYPE_STR_Point_M = _saga_api.SG_OGIS_TYPE_STR_Point_M
SG_OGIS_TYPE_STR_Line_M = _saga_api.SG_OGIS_TYPE_STR_Line_M
SG_OGIS_TYPE_STR_Polygon_M = _saga_api.SG_OGIS_TYPE_STR_Polygon_M
SG_OGIS_TYPE_STR_MultiPoint_M = _saga_api.SG_OGIS_TYPE_STR_MultiPoint_M
SG_OGIS_TYPE_STR_MultiLine_M = _saga_api.SG_OGIS_TYPE_STR_MultiLine_M
SG_OGIS_TYPE_STR_MultiPolygon_M = _saga_api.SG_OGIS_TYPE_STR_MultiPolygon_M
SG_OGIS_TYPE_STR_GeometryCollection_M = _saga_api.SG_OGIS_TYPE_STR_GeometryCollection_M
SG_OGIS_TYPE_STR_PolyhedralSurface_M = _saga_api.SG_OGIS_TYPE_STR_PolyhedralSurface_M
SG_OGIS_TYPE_STR_TIN_M = _saga_api.SG_OGIS_TYPE_STR_TIN_M
SG_OGIS_TYPE_STR_Triangle_M = _saga_api.SG_OGIS_TYPE_STR_Triangle_M
SG_OGIS_TYPE_STR_Point_ZM = _saga_api.SG_OGIS_TYPE_STR_Point_ZM
SG_OGIS_TYPE_STR_Line_ZM = _saga_api.SG_OGIS_TYPE_STR_Line_ZM
SG_OGIS_TYPE_STR_Polygon_ZM = _saga_api.SG_OGIS_TYPE_STR_Polygon_ZM
SG_OGIS_TYPE_STR_MultiPoint_ZM = _saga_api.SG_OGIS_TYPE_STR_MultiPoint_ZM
SG_OGIS_TYPE_STR_MultiLine_ZM = _saga_api.SG_OGIS_TYPE_STR_MultiLine_ZM
SG_OGIS_TYPE_STR_MultiPolygon_ZM = _saga_api.SG_OGIS_TYPE_STR_MultiPolygon_ZM
SG_OGIS_TYPE_STR_GeometryCollection_ZM = _saga_api.SG_OGIS_TYPE_STR_GeometryCollection_ZM
SG_OGIS_TYPE_STR_PolyhedralSurface_ZM = _saga_api.SG_OGIS_TYPE_STR_PolyhedralSurface_ZM
SG_OGIS_TYPE_STR_TIN_ZM = _saga_api.SG_OGIS_TYPE_STR_TIN_ZM
SG_OGIS_TYPE_STR_Triangle_ZM = _saga_api.SG_OGIS_TYPE_STR_Triangle_ZM
...
def SG_Polygon_Intersection(*args):
  return _saga_api.SG_Polygon_Intersection(*args)
SG_Polygon_Intersection = _saga_api.SG_Polygon_Intersection

def SG_Polygon_Difference(*args):
  return _saga_api.SG_Polygon_Difference(*args)
SG_Polygon_Difference = _saga_api.SG_Polygon_Difference

def SG_Polygon_ExclusiveOr(*args):
  return _saga_api.SG_Polygon_ExclusiveOr(*args)
SG_Polygon_ExclusiveOr = _saga_api.SG_Polygon_ExclusiveOr

def SG_Polygon_Union(*args):
  return _saga_api.SG_Polygon_Union(*args)
SG_Polygon_Union = _saga_api.SG_Polygon_Union

def SG_Polygon_Dissolve(*args):
  return _saga_api.SG_Polygon_Dissolve(*args)
SG_Polygon_Dissolve = _saga_api.SG_Polygon_Dissolve
...
SYMBOL_MLB_Initialize = _saga_api.SYMBOL_MLB_Initialize
SYMBOL_MLB_Finalize = _saga_api.SYMBOL_MLB_Finalize
SYMBOL_MLB_Get_Interface = _saga_api.SYMBOL_MLB_Get_Interface
...
class CSG_Module_Library_Manager(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, CSG_Module_Library_Manager, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, CSG_Module_Library_Manager, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _saga_api.new_CSG_Module_Library_Manager()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _saga_api.delete_CSG_Module_Library_Manager
    __del__ = lambda self : None;
    def Destroy(self): return _saga_api.CSG_Module_Library_Manager_Destroy(self)
    def Get_Count(self): return _saga_api.CSG_Module_Library_Manager_Get_Count(self)
    def Add_Library(self, *args): return _saga_api.CSG_Module_Library_Manager_Add_Library(self, *args)
    def Add_Directory(self, *args): return _saga_api.CSG_Module_Library_Manager_Add_Directory(self, *args)
    def Del_Library(self, *args): return _saga_api.CSG_Module_Library_Manager_Del_Library(self, *args)
    def Get_Library(self, *args): return _saga_api.CSG_Module_Library_Manager_Get_Library(self, *args)
    def Get_Module(self, *args): return _saga_api.CSG_Module_Library_Manager_Get_Module(self, *args)
CSG_Module_Library_Manager_swigregister = _saga_api.CSG_Module_Library_Manager_swigregister
CSG_Module_Library_Manager_swigregister(CSG_Module_Library_Manager)


def SG_Get_Module_Library_Manager():
  return _saga_api.SG_Get_Module_Library_Manager()
SG_Get_Module_Library_Manager = _saga_api.SG_Get_Module_Library_Manager
